...
class GlobalInfoController extends BaseController {
	...
	public function global_info_handler() {
		...
		$gd_site_created               = defined( 'GD_SITE_CREATED' ) ? GD_SITE_CREATED : null;
		$is_airo_site_designer         = (bool) get_option( 'wp_site_designer_activated', false );
		...
		return new \WP_REST_Response(
			array(
				'data' => array(
					...
					'gd_site_created'                 => $gd_site_created,
					'is_airo_site_designer'           => $is_airo_site_designer,
				),
			),
			200
		);
