...
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Integration\IntegrationInterface;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Integration\OTLPIntegration;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Logs\Logs;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Metrics\Metrics;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Metrics\TraceMetrics;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\State\Scope;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Tracing\PropagationContext;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Tracing\SpanContext;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Tracing\Transaction;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Tracing\TransactionContext;
