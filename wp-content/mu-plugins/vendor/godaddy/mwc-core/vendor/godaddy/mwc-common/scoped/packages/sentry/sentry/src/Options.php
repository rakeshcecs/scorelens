...
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Integration\ErrorListenerIntegration;
...
use GoDaddy\WordPress\MWC\Common\Vendor\Symfony\Component\OptionsResolver\Options as SymfonyOptions;
use GoDaddy\WordPress\MWC\Common\Vendor\Symfony\Component\OptionsResolver\OptionsResolver;
/**
...
final class Options
{
    ...
    private function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults(['integrations' => [], 'default_integrations' => \true, 'prefixes' => array_filter(explode(\PATH_SEPARATOR, get_include_path() ?: '')), 'sample_rate' => 1, 'enable_tracing' => null, 'traces_sample_rate' => null, 'traces_sampler' => null, 'profiles_sample_rate' => null, 'attach_stacktrace' => \false, 'attach_metric_code_locations' => \false, 'context_lines' => 5, 'environment' => $_SERVER['SENTRY_ENVIRONMENT'] ?? null, 'logger' => null, 'spotlight' => \false, 'spotlight_url' => 'http://localhost:8969', 'release' => $_SERVER['SENTRY_RELEASE'] ?? null, 'dsn' => $_SERVER['SENTRY_DSN'] ?? null, 'server_name' => gethostname(), 'ignore_exceptions' => [], 'ignore_transactions' => [], 'before_send' => static function (Event $event): Event {
            ...
            return $transaction;
        }, 'trace_propagation_targets' => null, 'tags' => [], 'error_types' => null, 'max_breadcrumbs' => self::DEFAULT_MAX_BREADCRUMBS, 'before_breadcrumb' => static function (Breadcrumb $breadcrumb): Breadcrumb {
            return $breadcrumb;
