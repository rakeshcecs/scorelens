...
class Request implements RequestContract
{
    ...
    /**
     * Sends the request and converts the result into an instance of the specified {@see ResponseContract} class.
     *
     ...
     * @throws InvalidUrlException|InvalidMethodException|Exception
     */
    protected function performRequest(string $responseClassName) : ResponseContract
    {
        $this->validate();

        return new $responseClassName(HttpRepository::performRequest(
            $this->buildUrlString(),
            [
                'body'      => $this->buildBody($this->headers),
    ...
    {
        return $this->body ? (string) json_encode($this->body) : null;
    }
