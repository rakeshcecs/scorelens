...
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\HttpClient\Request;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Options;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Serializer\PayloadSerializerInterface;
use GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Spotlight\SpotlightClient;
/**
 * @internal
 */
class HttpTransport implements TransportInterface
{
    ...
    private function sendRequestToSpotlight(Event $event): void
    {
        ...
        $request->setStringBody($this->payloadSerializer->serialize($event));
        try {
            $spotLightResponse = SpotlightClient::sendRequest($request, $this->options->getSpotlightUrl() . '/stream');
