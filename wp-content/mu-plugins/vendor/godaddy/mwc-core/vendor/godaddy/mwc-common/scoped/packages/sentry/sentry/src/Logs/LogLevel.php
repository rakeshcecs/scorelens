...
namespace GoDaddy\WordPress\MWC\Common\Vendor\Sentry\Logs;
...
class LogLevel
{
    ...
    public function toPsrLevel(): string
    {
        switch ($this->value) {
            case 'trace':
            case 'debug':
                return \GoDaddy\WordPress\MWC\Common\Vendor\Psr\Log\LogLevel::DEBUG;
            case 'warn':
                return \GoDaddy\WordPress\MWC\Common\Vendor\Psr\Log\LogLevel::WARNING;
            case 'error':
                return \GoDaddy\WordPress\MWC\Common\Vendor\Psr\Log\LogLevel::ERROR;
            case 'fatal':
                return \GoDaddy\WordPress\MWC\Common\Vendor\Psr\Log\LogLevel::CRITICAL;
            case 'info':
            default:
                return \GoDaddy\WordPress\MWC\Common\Vendor\Psr\Log\LogLevel::INFO;
        }
    }
