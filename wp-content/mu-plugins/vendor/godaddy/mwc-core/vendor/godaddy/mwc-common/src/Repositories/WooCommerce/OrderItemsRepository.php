...
{
    /** @use HasWooCommerceDataAccessorsTrait<WC_Order_Item|WC_Order_Item_Coupon|WC_Order_Item_Fee|WC_Order_Item_Product|WC_Order_Item_Shipping|WC_Order_Item_Tax> */
