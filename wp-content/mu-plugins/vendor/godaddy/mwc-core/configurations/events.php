...
return [
    ...
    'listeners' => [
        ...
        GoDaddy\WordPress\MWC\Core\Features\Commerce\Catalog\Events\BeforeLoadProductInformationEvent::class => [
            GoDaddy\WordPress\MWC\Core\Features\Commerce\Inventory\Events\Subscribers\PrimeInventoryCacheBeforeLoadingProductInformationSubscriber::class,
        ],
