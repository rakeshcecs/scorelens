...
class ProductAdapter extends CommonProductAdapter
{
    ...
    public function convertToSource($product = null, bool $getNewInstance = true) : WC_Product
    {
        ...
        if ($product) {
            ...
            // Map stock management setting to WooCommerce
            $this->source->set_manage_stock($product->getStockManagementEnabled());
     ...
     * @return void
     */
    public function convertMarketplacesDataFromSource(Product $product) : void
    {
