...
/**
 * GraphQL mutation operation for updating SKU Group relationships in the v2 API.
 *
 * This operation dynamically builds mutations based on the relationship updates provided.
 */
class UpdateSkuGroupRelationshipsOperation extends AbstractGraphQLOperation
{
    ...
    {
        return $this->buildDynamicRelationshipOperation('SkuGroup', '$skuGroupId', 'UpdateSkuGroupRelationships');
    }
}
