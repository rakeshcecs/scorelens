...
class ProductBase extends AbstractDataObject
{
    ...
    /** @var ?File[] used by digital products; set to null if files are not supported; set to empty array if there are simply no files */
    public ?array $files;

    /** @var Inventory|null the product's inventory */
    public ?Inventory $inventory;

    /** @var int|null low inventory threshold for notifications */
    public ?int $lowInventoryThreshold = null;
    ...
    /** @var string|null describes the type of product; if null then that indicates not supported */
