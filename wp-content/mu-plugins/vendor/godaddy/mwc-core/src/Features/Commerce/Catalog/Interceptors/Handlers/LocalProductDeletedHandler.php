...
{
    /** @var ProductMapRepositoryContract Products map repository for access to mapping */
    ...
    /** @var HandleLocalProductDeletedContract Handler for local product deletion */
    protected HandleLocalProductDeletedContract $deleteHandler;
     ...
     * @param HandleLocalProductDeletedContract $deleteHandler
     */
    public function __construct(ProductMapRepositoryContract $productMapRepository, ProductsServiceContract $productsService, HandleLocalProductDeletedContract $deleteHandler)
    {
    ...
    {
        $this->deleteHandler->handle(TypeHelper::int($wpPost->ID, 0));
    }
