...
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\ErrorHandling\NullMcpErrorHandler;
...
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\Observability\NullMcpObservabilityHandler;
...
class McpServer {
	 ...
	 *
	 * @var \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpComponentRegistry
	 */
	 ...
	 *
	 * @var \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpTransportFactory
	 */
	 ...
	 * @param class-string<\GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface>|null         $error_handler Error handler class to use (e.g., NullMcpErrorHandler::class). Must implement McpErrorHandlerInterface. If null, NullMcpErrorHandler will be used.
	...
	private function setup_handlers( ?string $error_handler, ?string $observability_handler ): void {
		...
		if ( $error_handler && class_exists( $error_handler ) ) {
			/** @var \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $handler */
		...
		if ( $observability_handler && class_exists( $observability_handler ) ) {
			/** @var \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface $handler */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpComponentRegistry
	 */
