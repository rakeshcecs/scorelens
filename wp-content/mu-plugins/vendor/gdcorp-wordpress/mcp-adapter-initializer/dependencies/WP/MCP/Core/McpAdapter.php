 ...
 *
 * @package GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core
 */
...
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Abilities\DiscoverAbilitiesAbility;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Abilities\ExecuteAbilityAbility;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Abilities\GetAbilityInfoAbility;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Cli\McpCommand;
...
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Servers\DefaultServerFactory;
...
final class McpAdapter {
	 ...
	 * Registry instance
	 *
	 * @var \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpAdapter
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpAdapter
	 */
	 ...
	 * @param class-string<\GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface> $error_handler The error handler class name. If null, NullMcpErrorHandler will be used.
	 * @param class-string<\GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface> $observability_handler The observability handler class name. If null, NullMcpObservabilityHandler will be used.
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpAdapter|\WP_Error McpAdapter instance on success, WP_Error on failure.
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpServer|null
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpServer[]
	 */
