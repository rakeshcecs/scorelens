 ...
 *
 * @package GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP
 */

declare( strict_types = 1 );

namespace GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP;
