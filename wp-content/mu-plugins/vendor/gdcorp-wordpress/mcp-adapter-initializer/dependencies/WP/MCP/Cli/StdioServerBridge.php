...
namespace GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Cli;

use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpServer;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Transport\Infrastructure\RequestRouter;
...
class StdioServerBridge {
	 ...
	 *
	 * @var \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
	 ...
	 *
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpServer $server The MCP server to expose.
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
