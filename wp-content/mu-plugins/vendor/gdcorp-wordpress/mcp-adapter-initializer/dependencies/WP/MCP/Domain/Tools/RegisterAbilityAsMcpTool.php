...
namespace GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools;

use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpServer;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Utils\McpAnnotationMapper;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Utils\SchemaTransformer;
use WP_Ability;
...
class RegisterAbilityAsMcpTool {
	 ...
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpServer $mcp_server The MCP server.
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\McpTool|\WP_Error Returns a new instance of McpTool or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\McpTool|\WP_Error The validated MCP tool instance or WP_Error if validation fails.
	 */
