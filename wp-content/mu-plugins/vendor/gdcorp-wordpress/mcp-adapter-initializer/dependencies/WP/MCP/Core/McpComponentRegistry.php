...
namespace GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core;

use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\McpPrompt;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\RegisterAbilityAsMcpPrompt;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Resources\McpResource;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Resources\RegisterAbilityAsMcpResource;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\McpTool;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\RegisterAbilityAsMcpTool;
...
class McpComponentRegistry {
	 ...
	 * Constructor.
	 *
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Core\McpServer $mcp_server MCP server instance.
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $error_handler Error handler instance.
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface $observability_handler Observability handler instance.
	...
	public function register_tools( array $tools ): void {
		foreach ( $tools as $tool_item ) {
			...
			if ( $this->mcp_validation_enabled ) {
				...
				$validation_result = \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\McpToolValidator::validate_tool_instance( $tool, $context_to_use );
	 ...
	 *
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\McpTool $tool The tool instance to register.
	 *
	 * @return void
	 */
	...
	public function register_prompts( array $prompts ): void {
		foreach ( $prompts as $prompt_item ) {
			...
			if ( class_exists( $prompt_item ) && in_array( McpPromptBuilderInterface::class, class_implements( $prompt_item ) ?: array(), true ) ) {
				...
				try {
					/** @var \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder */
				...
				if ( $this->mcp_validation_enabled ) {
					...
					$validation_result = \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\McpPromptValidator::validate_prompt_instance( $prompt, $context_to_use );
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\McpTool[]
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Resources\McpResource[]
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\McpPrompt[]
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Tools\McpTool|null
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Resources\McpResource|null
	 */
	 ...
	 *
	 * @return \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\McpPrompt|null
	 */
