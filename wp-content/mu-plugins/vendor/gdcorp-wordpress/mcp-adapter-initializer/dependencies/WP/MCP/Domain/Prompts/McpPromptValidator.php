...
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Resources\McpResourceValidator;
use GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Utils\McpValidator;
...
class McpPromptValidator {
	 ...
	 *
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\McpPrompt $prompt The prompt instance to validate.
	 * @param string    $context Optional context for error messages.
	 *
	 * @return bool|\WP_Error True if valid, WP_Error if validation fails.
	 */
	 ...
	 *
	 * @param \GoDaddy\WordPress\Plugins\MCPAdapterInitializer\Dependencies\WP\MCP\Domain\Prompts\McpPrompt $prompt The resource instance to validate.
	 * @param string    $context Optional context for error messages.
	 *
