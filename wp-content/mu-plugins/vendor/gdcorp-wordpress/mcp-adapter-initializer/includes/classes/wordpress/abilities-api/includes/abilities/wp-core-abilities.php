...
function wp_register_core_abilities(): void {
			...
			'input_schema'        => array(
				...
				'properties'           => array(
					'fields' => array(
						...
						'description' => __( 'GD_MCP_ADAPTER_INITIALIZER_Optional: Limit response GD_MCP_ADAPTER_INITIALIZER_to specific fields. If omitted, all fields are returned.' ),
					),
				),
	...
	wp_register_ability(
		...
		array(
			...
			'description'         => __( 'Returns basic profile details GD_MCP_ADAPTER_INITIALIZER_for the current authenticated user GD_MCP_ADAPTER_INITIALIZER_to support personalization, auditing, and access-aware behavior.' ),
			...
			'output_schema'       => array(
				...
				'properties'           => array(
					...
					'display_name'  => array(
						'type'        => 'string',
						'description' => __( 'The display GD_MCP_ADAPTER_INITIALIZER_name of the user.' ),
					),
					'user_nicename' => array(
						'type'        => 'string',
						'description' => __( 'The URL-friendly GD_MCP_ADAPTER_INITIALIZER_name GD_MCP_ADAPTER_INITIALIZER_for the user.' ),
					),
					'user_login'    => array(
						'type'        => 'string',
						'description' => __( 'The login username GD_MCP_ADAPTER_INITIALIZER_for the user.' ),
					),
					'roles'         => array(
						'type'        => 'array',
						'description' => __( 'The roles assigned GD_MCP_ADAPTER_INITIALIZER_to the user.' ),
						'items'       => array(
							'type' => 'string',
						),
					),
					'locale'        => array(
						'type'        => 'string',
						'description' => __( 'The locale string GD_MCP_ADAPTER_INITIALIZER_for the user, such as en_US.' ),
					),
				),
				'additionalProperties' => false,
			),
	...
	wp_register_ability(
		...
		array(
			...
			'description'         => __( 'Returns core details about the site\'s runtime context GD_MCP_ADAPTER_INITIALIZER_for diagnostics and compatibility (environment, PHP runtime, database server info, WordPress version).' ),
			'category'            => $category_site,
			'output_schema'       => array(
				'type'                 => 'object',
