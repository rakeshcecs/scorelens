...
final class REST_API {
     ...
     * @return bool
     */
    public function validate_signature( $headers, $body = '[]' ) {
	...
	public function flush_cache() {
		register_rest_route( $this->namespaces['v1'], 'flush-cache', [
			...
			$this->validated['flush_cache'] = $this->validate_signature($signature, $request->get_body() ?: '[]');
	...
	public function diagnostics_data() {
		register_rest_route( $this->namespaces['v1'], 'diagnostics', [
			...
			$this->validated['diagnostics'] = $this->validate_signature($signature, $request->get_body() ?: '[]');
    ...
    public function activity_log() {
        ...
        register_rest_route( $this->namespaces['v1'], '/activity-logs', array(
            ...
            'permission_callback' => function($request) {
                ...
                $this->validated['get_activity_log'] = $this->validate_signature($signature, $request->get_body() ?: '[]');
	...
	public function plugins_to_update() {
		register_rest_route( $this->namespaces['v1'], 'plugin-updates', [
			...
			'permission_callback' => function($request) {
				...
				$this->validated['plugin-updates'] = $this->validate_signature($signature, $request->get_body() ?: '[]');
    ...
    public function get_2_fa_status() {
        register_rest_route( $this->namespaces['v1'], '2fa-status', [
            ...
            'permission_callback' => function($request) {
                ...
                $this->validated['2fa_status'] = $this->validate_signature($signature, $request->get_body() ?: '[]');
