...
final class Bar {
	...
	private function whats_new_menu_item() {
		...
		$dismissed = get_option( 'wpaas_whats_new_dismissed', false );
		$green_dot = $dismissed ? '' : ' <span class="wpaas-green-dot"></span>';

		$this->admin_bar->add_menu(
			[
				'id'     => 'wpaas-whats-new',
				'href'   => 'https://www.godaddy.com/resources/news/wordpress-7-0-real-time-collaboration-arrives-in-core',
				'title'  => sprintf(
					'%s%s <span class="dashicons dashicons-external"></span>',
